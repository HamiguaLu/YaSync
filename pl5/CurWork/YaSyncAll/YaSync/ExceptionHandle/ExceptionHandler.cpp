...
static void DumpStack(HANDLE LogFile, DWORD *pStack)
{
	...
	__except(EXCEPTION_EXECUTE_HANDLER)
	{
		...
		PEWriteLog2File(_T("Exception encountered during stack dump.\r\n"));
	}
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
TCHAR szExceptionLogPath[MAX_PATH];
...
int __cdecl RecordExceptionInfo(PEXCEPTION_POINTERS pExceptPtrs)
{
	...
	_tcscat(szLogPath,XCRASHREPORT_ERROR_LOG_FILE);

	PEWriteLog2File(_T("----------Open Log----------------"));
	PEWriteLog2File(szLogPath);

	_tcscpy(szExceptionLogPath,szLogPath);
	...
	{
		PEWriteLog2File(_T("Error creating exception report\r\n"));
		return EXCEPTION_CONTINUE_SEARCH;
	}
				...
				Exception->NumberParameters >= 2)
	{
		...
		PEWriteLog2File(_T("Exception handler: "));
		PEWriteLog2File(szDebugMessage);
#endif
	...
	PEWriteLog2File(_T("DumpModuleList"));
	...
	extern int GetAppDataPath(TCHAR* szPath);
	GetAppDataPath(szLogPath);
	_tcscat(szLogPath,XCRASHREPORT_MINI_DUMP_FILE);
