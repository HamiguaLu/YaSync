...
#define		PE_LOG_FILE_NAMEA									"YaSync_LogA.txt"
...
{
	SCAN_STAT_ADB = 0,
	SCAN_STAT_QUERY_FROM_SRV,
	SCAN_STAT_CONNECT_2_CLIENT,
	SCAN_STAT_CONNECT_FROM_HISTORY,
	SCAN_STAT_STOP
};
...
{	
	...
	DWORD dwSyncImage;
	TCHAR szImageFolderName[255];

	DWORD dwSyncVideo;
	TCHAR szVideoFolderName[255];

	DWORD dwSyncAudio;
	TCHAR szAudioFolderName[255];
...
{
	ULONG	ulCalendarID;
	TCHAR	szAccountName[255];
	TCHAR	szAccountType[255];
	TCHAR	szDisplayName[255];
	TCHAR	szName[255];
	int		visible;
} CAL_ITEM;
